...
//                   {colorpaper && (
//                     <Confetti
//                       stageHeight={setWindowSize.height}
//                       numberOfPieces={2000}
//                       gravity={1}
//                       duration={5000}
//                       recycle={false}
...
import Sidebarss from "../components/Resume/Sidebarss";
import Maincontent from "../components/Resume/Maincontent";
import Footer from "../components/Resume/Footer";
import "../components/Resume/mainresume.css";

export const Resume = () => {
  const [isDarkMode, setIsDarkMode] = useState(true);

  return (
    <div className={`app1 ${isDarkMode ? "dark-mode" : "light-mode"}`}>
      <Hero />
